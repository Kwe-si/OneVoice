...
function listing($conn){
    $ashiaman=mysqli_query($conn, "SELECT concat(P.fname, ' ', P.middlename, ' ', P.lname) as Fullname, DP.projectName, DPM.projectrole
    ...
    $data=mysqli_fetch_all($ashiaman,MYSQLI_ASSOC);
    return $data;
}
...
<body>
    ...
    <div class="table-responsive">
        <table class="table table-hover table-color table-bordered att">
            ...
            <!-- looping through rows with results of the query to display the details of the Ashiaman Project -->
