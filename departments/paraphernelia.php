...
function listing($conn){
    $prayer_dept=mysqli_query($conn, "SELECT concat(P.fname, ' ', P.middlename, ' ', P.lname) as Fullname, D.deptName
    ...
    where D.deptName like '%Paraphernelia%' ");
    $data=mysqli_fetch_all($prayer_dept,MYSQLI_ASSOC);
    return $data;
}
...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark navbarcolor">
        ...
        <a href="../php/department.php"><button type="button" class="btn back-button">Back</button></a> 
